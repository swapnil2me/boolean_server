...
class SVRF:
    ...
    def write_bool_to_list(self):
        ...
        line_list.append("""<style>
                            ...
                            div > div > div > div > div > div > div > div > div { background: #fee6ce;
                            }

                            div > div > div > div > div > div > div > div > div > div { background: #fdae6b;
                            }

                            div > div > div > div > div > div > div > div > div > div > div { background: #e6550d;
                            }

                            div > div > div > div > div > div > div > div > div > div > div > div { background: #efedf5;
                            }

                            div > div > div > div > div > div > div > div > div > div > div > div > div { background: #bcbddc;
                            }

                            div > div > div > div > div > div > div > div > div > div > div > div > div > div { background: #756bb1;
                            }

                            div > div > div > div > div > div > div > div > div > div > div > div > div > div > div { background: #e5f5e0;
                            }

                            div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div { background: #a1d99b;
                            }
                            </style>""")
        return line_list
